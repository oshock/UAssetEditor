...
public class FPackageFileVersion
{
	...
	public FPackageFileVersion(EUnrealEngineObjectUE4Version UE4, EUnrealEngineObjectUE5Version UE5)
	{
		FileVersionUE4 = UE4;
		FileVersionUE5 = UE5;
	}
	...
	public static FPackageFileVersion AUTO = new(
		EUnrealEngineObjectUE4Version.VER_UE4_AUTOMATIC_VERSION, EUnrealEngineObjectUE5Version.AUTOMATIC_VERSION);

	public static FPackageFileVersion CreateUE4Version(int version) => new((EUnrealEngineObjectUE4Version)version,
	...
	public static FPackageFileVersion CreateUE4Version(EUnrealEngineObjectUE4Version version) =>
		new(version, EUnrealEngineObjectUE5Version.AUTOMATIC_VERSION);

	public static FPackageFileVersion CreateUE5Version(EUnrealEngineObjectUE5Version version) =>
		new(EUnrealEngineObjectUE4Version.VER_UE4_AUTOMATIC_VERSION, version);
	
	#region UE4_Operators
	public static bool operator !=(FPackageFileVersion myVer, EUnrealEngineObjectUE4Version ver) => myVer.FileVersionUE4 != ver;
	public static bool operator ==(FPackageFileVersion myVer, EUnrealEngineObjectUE4Version ver) => myVer.FileVersionUE4 == ver;
	public static bool operator >(FPackageFileVersion myVer, EUnrealEngineObjectUE4Version ver) => myVer.FileVersionUE4 > ver;
	public static bool operator <(FPackageFileVersion myVer, EUnrealEngineObjectUE4Version ver) => myVer.FileVersionUE4 < ver;
	public static bool operator >=(FPackageFileVersion myVer, EUnrealEngineObjectUE4Version ver) => myVer.FileVersionUE4 >= ver;
	...
	public static bool operator !=(FPackageFileVersion myVer, EUnrealEngineObjectUE5Version ver) => myVer.FileVersionUE5 != ver;
	public static bool operator ==(FPackageFileVersion myVer, EUnrealEngineObjectUE5Version ver) => myVer.FileVersionUE5 == ver;
	public static bool operator >(FPackageFileVersion myVer, EUnrealEngineObjectUE5Version ver) => myVer.FileVersionUE5 > ver;
	public static bool operator <(FPackageFileVersion myVer, EUnrealEngineObjectUE5Version ver) => myVer.FileVersionUE5 < ver;
	public static bool operator >=(FPackageFileVersion myVer, EUnrealEngineObjectUE5Version ver) => myVer.FileVersionUE5 >= ver;
